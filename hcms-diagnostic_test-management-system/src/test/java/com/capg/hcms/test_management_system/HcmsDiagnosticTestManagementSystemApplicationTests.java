...
class HcmsDiagnosticTestManagementSystemApplicationTests {
	...
	@BeforeEach
	public void init() {
		test1 = new DiagnosticTest("", "LFT");
		test2 = new DiagnosticTest("84409", "MRI scanning");
	}
	...
	public void testException() {
		...
		assertEquals("["+test2.getTestId()+"] is Not Found", exception.getMessage());
	}
	
//	@Test
//	public void testException1() {
//		Throwable exception = assertThrows(ListEmptyException.class, ()->{
//			service.getAllTests();
//		});
